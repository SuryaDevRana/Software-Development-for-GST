<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-bold text-3xl text-gray-900 dark:text-white">Edit Product</h2>
                    ...
                    <div class="flex space-x-3 mb-3">
                        @foreach([5, 12, 18, 28] as $rate)
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="gst_rate" value="{{ $rate }}" {{ old('gst_rate', $product->gst_rate) == $rate ? 'checked' : '' }} class="w-4 h-4 text-purple-600 focus:ring-purple-500">
